...
export const apps = {
  hanimcilik: {
    ...
    supportUrl: `${base}hanimcilik/support.html`,
    ctaLabel: "App Store'dan İndir",
  ...
  "dualcam-capture": {
    slug: "dualcam-capture",
    eyebrow: "Dual Camera Recorder",
    title: "DualCam Capture",
    heroTitle: "Capture with both cameras at once.",
    heroSubtitle: "Dual Camera Photo & Video Recorder",
    description:
      "Turn your iPhone into a powerful dual-camera recorder. Capture with the front and back cameras at the same time, switch layouts instantly, and create dynamic dual-camera photos and videos from one simple recording screen.",
    locales: {
      tr: {
        eyebrow: "Çift Kamera Kaydedici",
        title: "DualCam Capture",
        heroTitle: "İki kamerayla aynı anda kayıt alın.",
        heroSubtitle: "Çift Kamera Fotoğraf ve Video Kaydedici",
        description:
          "iPhone’unuzu güçlü bir çift kamera kaydediciye dönüştürün. Ön ve arka kamerayla aynı anda kayıt alın, düzenleri anında değiştirin ve tek bir kayıt ekranından dinamik çift kamera fotoğraf ve videoları üretin.",
        heroScreen: appAsset("dualcam-capture", "tr/screenshot-01.png"),
        gallery: [
          appAsset("dualcam-capture", "tr/screenshot-02.png"),
          appAsset("dualcam-capture", "tr/screenshot-03.png"),
          appAsset("dualcam-capture", "tr/screenshot-04.png"),
          appAsset("dualcam-capture", "tr/screenshot-05.png"),
          appAsset("dualcam-capture", "tr/screenshot-06.png"),
        ],
        chips: [
          "Ön + arka kamera birlikte",
          "Fotoğraf ve video",
          "Anında düzen değişimi",
          "Picture‑in‑Picture kontrolü",
        ],
        features: [
          "Ön ve arka kamerayla aynı anda kayıt",
          "Fotoğraf ve video çekimi",
          "Farklı çoklu kamera düzenleri",
          "Picture‑in‑Picture konumunu taşıma ve ayarlama",
          "Kayıt kalitesi seçenekleri arasında geçiş",
          "Kare hızı ayarları",
          "Daha dinamik çekim için yüz takibi",
          "Kayıt sırasında zoom ve pozlama ayarı",
          "Fotoğraf ve videoları kütüphaneye kaydetme",
          "Uygulama içinde çekimleri inceleme",
        ],
        ctaLabel: "App Store — Yakında",
        secondaryLabel: "Gizlilik",
      },
      en: {
        ...
        description:
          "Turn your iPhone into a powerful dual-camera recorder. Capture with the front and back cameras at the same time, switch layouts instantly, and create dynamic dual-camera photos and videos from one simple recording screen.",
        heroScreen: appAsset("dualcam-capture", "en/screenshot-01.png"),
        gallery: [
          appAsset("dualcam-capture", "en/screenshot-02.png"),
          appAsset("dualcam-capture", "en/screenshot-03.png"),
          appAsset("dualcam-capture", "en/screenshot-04.png"),
          appAsset("dualcam-capture", "en/screenshot-05.png"),
          appAsset("dualcam-capture", "en/screenshot-06.png"),
        ],
        chips: [
          "Front + back cameras together",
          "Photos and videos",
          "Instant layout switching",
          "Picture-in-picture control",
        ],
        features: [
          "Record with front and back cameras together",
          "Capture both photos and videos",
          "Choose different multi-camera layouts",
          "Move and adjust Picture in Picture placement",
          "Switch between recording quality options",
          "Select frame rate settings",
          "Use face tracking for more dynamic capture",
          "Adjust zoom and exposure while shooting",
          "Save photos and videos to your library",
          "Review captured media inside the app",
        ],
        ctaLabel: "App Store — Coming Soon",
        secondaryLabel: "Privacy",
      },
      es: {
        eyebrow: "Grabador de Doble Cámara",
        title: "DualCam Capture",
        heroTitle: "Graba con ambas cámaras a la vez.",
        heroSubtitle: "Grabador de Fotos y Videos con Doble Cámara",
        description:
          "Convierte tu iPhone en un potente grabador de doble cámara. Graba con la cámara frontal y trasera al mismo tiempo, cambia diseños al instante y crea fotos y videos dinámicos desde una sola pantalla de grabación.",
        heroScreen: appAsset("dualcam-capture", "es/screenshot-01.png"),
        gallery: [
          appAsset("dualcam-capture", "es/screenshot-02.png"),
          appAsset("dualcam-capture", "es/screenshot-03.png"),
          appAsset("dualcam-capture", "es/screenshot-04.png"),
          appAsset("dualcam-capture", "es/screenshot-05.png"),
          appAsset("dualcam-capture", "es/screenshot-06.png"),
        ],
        chips: [
          "Cámara frontal + trasera",
          "Fotos y videos",
          "Cambio de diseño instantáneo",
          "Control Picture‑in‑Picture",
        ],
        features: [
          "Graba con cámara frontal y trasera a la vez",
          "Captura fotos y videos",
          "Elige diferentes diseños multicámara",
          "Mueve y ajusta la posición Picture‑in‑Picture",
          "Cambia opciones de calidad de grabación",
          "Selecciona ajustes de FPS",
          "Usa seguimiento facial para capturas dinámicas",
          "Ajusta zoom y exposición mientras grabas",
          "Guarda fotos y videos en tu biblioteca",
          "Revisa el contenido capturado en la app",
        ],
        ctaLabel: "App Store — Próximamente",
        secondaryLabel: "Privacidad",
      },
      pt: {
        eyebrow: "Gravador de Câmera Dupla",
        title: "DualCam Capture",
        heroTitle: "Grave com as duas câmeras ao mesmo tempo.",
        heroSubtitle: "Gravador de Fotos e Vídeos com Câmera Dupla",
        description:
          "Transforme seu iPhone em um poderoso gravador de câmera dupla. Grave com as câmeras frontal e traseira ao mesmo tempo, troque layouts instantaneamente e crie fotos e vídeos dinâmicos em uma única tela de gravação.",
        heroScreen: appAsset("dualcam-capture", "ptbr/screenshot-01.png"),
        gallery: [
          appAsset("dualcam-capture", "ptbr/screenshot-02.png"),
          appAsset("dualcam-capture", "ptbr/screenshot-03.png"),
          appAsset("dualcam-capture", "ptbr/screenshot-04.png"),
          appAsset("dualcam-capture", "ptbr/screenshot-05.png"),
          appAsset("dualcam-capture", "ptbr/screenshot-06.png"),
        ],
        chips: [
          "Câmeras frontal + traseira",
          "Fotos e vídeos",
          "Troca de layout instantânea",
          "Controle Picture‑in‑Picture",
        ],
        features: [
          "Grave com as câmeras frontal e traseira juntas",
          "Capture fotos e vídeos",
          "Escolha diferentes layouts multicâmera",
          "Mova e ajuste a posição Picture‑in‑Picture",
          "Alterne opções de qualidade de gravação",
          "Selecione configurações de FPS",
          "Use rastreamento facial para capturas dinâmicas",
          "Ajuste zoom e exposição durante a gravação",
          "Salve fotos e vídeos na sua biblioteca",
          "Revise o conteúdo capturado no app",
        ],
    ...
    icon: appAsset("dualcam-capture", "icon.svg"),
    heroScreen: appAsset("dualcam-capture", "en/screenshot-01.png"),
    gallery: [
      appAsset("dualcam-capture", "en/screenshot-02.png"),
      appAsset("dualcam-capture", "en/screenshot-03.png"),
    ...
    privacyUrl: `${base}dualcam-capture/privacy.html`,
    supportUrl: `${base}dualcam-capture/support.html`,
    ctaLabel: "App Store — Coming Soon",
    secondaryLabel: "Privacy",
    secondaryUrl: `${base}dualcam-capture/privacy.html`,
    storeUrl: "#",
    medicalNote: null,
  },
  "shotzin-cam": {
    ...
    heroSubtitle: "Portrait + Landscape Video",
    description:
      "TwinFrame Cam is a creator camera app built for multi-platform posting. Frame once with dual guides, trim quickly after recording, choose a cover frame, and export social-ready versions from the same session.",
    locales: {
      tr: {
        ...
        description:
          "TwinFrame Cam, çoklu platform paylaşımı için tasarlanmış creator kamera uygulamasıdır. Çift framing kılavuzuyla tek seferde doğru kadrajı koru, çekim sonrası hızlıca trim yap, kapak karesini seç ve aynı oturumdan paylaşmaya hazır videolar üret.",
        ...
        features: [
          "Tek çekimden 9:16 portre ve 16:9 yatay çıktı üret",
          "Çift framing kılavuzuyla iki formatı da daha güvenli kadrajla",
          "Çekimden hemen sonra videoyu kısalt ve cover frame seç",
          "TikTok, Reels, WhatsApp Status, Kwai ve YouTube için hazır dışa aktarma",
          "1080p ve 4K, 24 / 30 / 60 FPS, MP4 ve MOV desteği",
          "Ses kaydı, time-lapse, zoom, torch ve AE/AF lock kontrolleri",
          "Ön/arka kamera geçişi ve hızlı paylaşım akışı",
          "Tamamlanan oturumları uygulama içi galeride yeniden aç",
        ],
        ctaLabel: "App Store — Yakında",
        secondaryLabel: "Gizlilik",
      },
      en: {
        ...
        chips: ["Creator workflow", "9:16 + 16:9", "4K + 60 FPS", "Gallery"],
        features: [
          "Record once and generate portrait 9:16 plus landscape 16:9 outputs",
          "Use dual framing guides to keep both formats safer in frame",
          "Trim clips fast after recording and choose the right cover frame",
          "Export for TikTok, Reels, WhatsApp Status, Kwai, and YouTube",
          "1080p and 4K capture with 24 / 30 / 60 FPS and MP4 / MOV support",
          "Optional audio recording, time-lapse, zoom, torch, and AE/AF lock",
          "Quick front/back camera switching and fast sharing flow",
          "Reopen finished sessions anytime in the in-app gallery",
        ],
        ctaLabel: "App Store — Coming Soon",
        secondaryLabel: "Privacy",
      },
      pt: {
        ...
        description:
          "TwinFrame Cam é uma câmera para criadores feita para publicação multiplataforma. Enquadre uma vez com guias duplas, corte rapidamente após a gravação, escolha a capa e exporte versões prontas para redes sociais da mesma sessão.",
        ...
        features: [
          "Grave uma vez e gere saídas em retrato 9:16 e paisagem 16:9",
          "Use guias de enquadramento duplas para proteger os dois formatos",
          "Corte os clipes rapidamente após gravar e escolha a capa ideal",
          "Exporte para TikTok, Reels, WhatsApp Status, Kwai e YouTube",
          "Gravação em 1080p e 4K com suporte a 24 / 30 / 60 FPS e MP4 / MOV",
          "Áudio opcional, time-lapse, zoom, lanterna e bloqueio AE/AF",
          "Troca rápida entre câmera frontal e traseira com fluxo ágil de compartilhamento",
          "Reabra sessões finalizadas quando quiser na galeria do app",
        ],
        ctaLabel: "App Store — Em breve",
        secondaryLabel: "Privacidade",
      },
    ...
    privacyUrl: `${base}shotzin-cam/privacy.html`,
    supportUrl: `${base}shotzin-cam/support.html`,
    ctaLabel: "App Store — Coming Soon",
    secondaryLabel: "Privacy",
    secondaryUrl: `${base}shotzin-cam/privacy.html`,
    storeUrl: "#",
    medicalNote: null,
  },
  "qr-reader-creator": {
